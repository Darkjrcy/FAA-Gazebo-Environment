...
def generate_launch_description():
    ...
    main_folder_path = "/home/adcl/FAA-Gazebo-Environment/DATA/MIT_Fligths_variable_Camera" # Notice Change the folder with the path to your fodler DATA to save it !
